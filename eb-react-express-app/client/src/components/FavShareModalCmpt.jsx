...
import cssobj from "@/stylesheet/fav-share-modal-cmpt.scss";

// Share modal component
export default class FavShareModalCmpt extends React.Component {
    constructor(props) {
        super(props);
        ...
        return (
            <Modal show={this.state.show} onHide={this.handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title className={cssobj["modal-title"]}>
                        { this.state.source.toUpperCase() }
                        <br />
                        <span className={cssobj["modal-subtitle"]}>{ this.state.header }</span>
                    </Modal.Title>
                </Modal.Header>
